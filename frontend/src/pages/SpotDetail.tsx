...
const SpotDetail = () => {
  ...
  const loadSpotDetail = async () => {
    try {
      ...
      const response = await api.get<Spot>(`/spots/${spotId}`)
  ...
  const handleLike = async () => {
    ...
    try {
      const response = await api.post<Spot>(`/spots/${spotId}/like`)
      if (response.data) {
  ...
  const handleFavorite = async () => {
    ...
    setIsSubmitting(true)
    try {
      const response = await api.post<Spot>(`/spots/${spotId}/favorite`)
      if (response.data) {
