...
import type { UserDTO, FileUploadResponse, UpdateProfileRequest } from '../types'
...
const ProfileEdit = () => {
  ...
  const [avatarUrl, setAvatarUrl] = useState<string>('https://cdn-icons-png.flaticon.com/512/616/616408.png')
  ...
  const handleAvatarUpload = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (response.data && 'url' in response.data) {
        const newAvatarUrl = response.data.url.startsWith('http')
          ? response.data.url
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <textarea
                  value={userInfo.bio}
                  onChange={(e: ChangeEvent<HTMLTextAreaElement>) => handleChange('bio', e.target.value)}
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('birthday', e.target.value)}
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    border: '2px solid #e5e7eb',
